<div class="container" style="height: 525px; background-color: #DDDDDD;">
	<center><br><h4>Laporan Transaksi Part Perbulan</h4><br></center>
	<div class="row">
		...
		<div class="col-md-7">
			<div class="row">
				<div class="col-md-5">
					...
					<td><a href="<?php echo site_url('Admin/laporanTransaksiPart') ?>"><button style="background-color: navy; color: white;">Bulan</button></a></td>
					<td><a href="<?php echo site_url('Admin/laporanTransaksiPartYear') ?>"><button>Tahun</button></a></td>
					<td><a href="<?php echo site_url('PrintPdf/BulanP') ?>"><button>Cetak</button></a>
				</div>
			</div><br>
