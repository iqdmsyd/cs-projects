...
class ModelSupply extends CI_Model
{
  ...
  {
    $this->db->select('tb_lowongan_kerja.ID, tb_lowongan_kerja.Judul, tb_lowongan_kerja.Kategori, tb_lowongan_kerja.Deskripsi, tb_lowongan_kerja.Pendaftar, tb_lowongan_kerja.Kuota, tb_lowongan_kerja.Kecamatan, tb_lowongan_kerja.Gaji, tb_perusahaan.NamaPerusahaan');
