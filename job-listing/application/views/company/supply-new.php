              ...
              <div class="container mt-2">
                <div class="row">
                  <div class="col-12 form-add-lowongan">
                    <h5>Tambah Lowongan Kerja Baru</h5>
                    ...
                    <form class="" action="<?php echo base_url(); ?>newsupply" method="post">
                      <div class="form-group row">
                        <label for="" class="col-4 col-form-label-sm">Judul Lowongan</label>
                        <div class="col-8">
                          <input type="text" name="Judul" class="form-control form-control-sm" placeholder="Judul lowongan" required autofocus>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-8">
                          <input type="text" name="Gaji" class="form-control form-control-sm" placeholder="Gaji" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-8">
                          <textarea name="Deskripsi" class="form-control form-control-sm" placeholder="Deskripsi" required>
                          </textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-8">
                          <input type="number" name="Kuota" class="form-control form-control-sm" min="1" max="50" placeholder="1" required>
                        </div>
                      </div>
