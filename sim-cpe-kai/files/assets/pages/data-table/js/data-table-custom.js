$(document).ready(function() {
    ...
    $('#manifestServerSideTable').on( 'processing.dt', function ( e, settings, processing ) {
        if (processing) {
         $("#tableCardBlock").LoadingOverlay("show");
        } else {
         $("#tableCardBlock").LoadingOverlay("hide", true);
        }
    })
    ...
    var manifestServerSideTable = $('#manifestServerSideTable').DataTable( {
        "processing"    : true,
        "serverSide"    : true,
        "ordering"      : true,
        "searching"     : true,
        "ajax"          : "Transaction/getManifest",
        "dom"           : '<"top"Bfl>rt<"bottom"ip>',
        "buttons"       : [
                            'copyHtml5',
                            {extend: 'csvHtml5',title: 'Manifest_'+dateTime},
                            {extend: 'excelHtml5',title: 'Manifest_'+dateTime},
                            'colvis'],
    ...
    $(document).ready(function() {
      $('#manifestServerSideTable').dataTable().fnFilterOnReturn();
      } );
    ...
    $('#clear_state_button').on('click', function() {
        manifestServerSideTable.state.clear();
    ...
    $(document).ready( function () {
        $("#date_filter_button").click(function () {
            $('#manifestServerSideTable').DataTable().draw();
        });
    } );*/
