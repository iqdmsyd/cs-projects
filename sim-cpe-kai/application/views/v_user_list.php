                          ...
                          <div class="col-lg-4">
                              <div class="page-header-breadcrumb">
                                  <ul class="breadcrumb-title">
                                      ...
                                      <li class="breadcrumb-item"><a href="<?php echo base_url("user/list") ?>">Users List</a> </li>
                                  </ul>
                              </div>
                          </div>
                      </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <div class="dt-responsive table-responsive">
                                            ...
                                            <tr>
                                              ...
                                              <td class="p-1 text-center"><label class="<?php 
                                               ...
                                               <td class="p-1 text-center">
                                                <button type="button" class="label label-warning btn btn-sm" data-toggle="modal" data-target="#userListModal" data-id_user="<?php echo $val->ID_USER ?>" data-nip="<?php echo $val->NIP ?>" data-username="<?php echo $val->USERNAME ?>" data-nama_lengkap="<?php echo $val->NAMA_LENGKAP ?>" data-email="<?php echo $val->EMAIL ?>" data-tipe_user="<?php echo $val->NAMA_TIPE_USER ?>">
                                    ...
                                    <a href="#!" data-toggle="tooltip" data-trigger="hover" data-placement="right" title="Please use the register function from register page to add new user"><i class="feather icon-user-plus"></i> Add new user</a>
                                </div>
                            </div>
                        </div>
                      </div>
...
<div class="modal fade" id="userListModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="" action="<?php echo base_url('User/proses_edit') ?>" method="POST">
        <input type="hidden" id="id_user" class="form-control" name="id">
        <div class="form-group">
          <label>NIPP</label>
          <input type="text" id="nip" class="form-control" name="nip" value="nip">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select id="tipe_user" class="custom-select" name="tipe">
      ...
      <div class="modal-footer">
          ...
          <button id="submit" type="submit" class="btn btn-sm btn-warning waves-effect waves-light"><i class="feather icon-edit"></i>Edit</button>
      </div>
      </form>
    </div>
  </div>
